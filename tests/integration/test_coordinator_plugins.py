...
def _fresh_registry():
    ...
    from claimed.iterate.iterate2.plugin import coordinator as coord_pkg
...
class TestSQLiteCoordinator:
    def _make_storage(self, db_url: str):
        from claimed.iterate.iterate2.plugin.coordinator.sqlite import SQLiteCoordinator
    ...
    def test_resolve_storage_via_registry(self, tmp_path):
        ...
        from claimed.iterate.iterate2.plugin.coordinator import (
...
class TestJournalFSCoordinator:
    def _make_storage(self, journal_path: str):
        from claimed.iterate.iterate2.plugin.coordinator.journalfs import JournalFSCoordinator
...
class TestPostgreSQLCoordinator:
    def test_matches_postgresql_scheme(self):
        from claimed.iterate.iterate2.plugin.coordinator.postgresql import PostgreSQLCoordinator
    ...
    def test_normalises_legacy_scheme(self):
        ...
        from claimed.iterate.iterate2.plugin.coordinator.postgresql import _extract_host
